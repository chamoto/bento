...
```csv
タイムスタンプ,氏名,7月14日,7月15日,7月16日,7月17日
2026/07/08 13:23:07,茶本,123大盛：こくうまポーク,126大盛：オリジナルチキン,127大盛：あの時のビーフ,128大盛：メンチカツ
```

`day1` から `day4`、または `7月14日` のような日付列には弁当番号を入れてください。`123大盛：こくうまポーク` のように商品名が付いていても、先頭の `123` だけを弁当番号として集計します。
